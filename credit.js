  ...
  if(creditAnchor&&!document.getElementById('creatorCredit')){
    ...
    credit.innerHTML='Designed and developed by Lim Kim Sze<br><span style="font-weight:700">Inspired by MOE’s School-based Dyslexia Remediation (SDR) curriculum</span>';
